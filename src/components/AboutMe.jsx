function AboutMe(){
    ...
    return (
        <div className="px-6">
            ...
            <p className="py-2">People helping other people. What a concept! </p>

            <p className="py-2">This website was made with ❤️ using Vite, React, and Tailwind. And lots of coffee and La Croix 🤪</p>
