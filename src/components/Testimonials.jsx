        ...
        <div className="lg:grid lg:grid-cols-2">
            ...
            <div className="lg:col-span-1 lg:mx-4 xl:mx-32">
                <div className="px-8 py-8 rounded-lg bg-white">
                    ...
                    <p className="text-black font-light"> Unfortunately, I'm not very good with computers, and I definitely could not afford spending money on development services in this economy! Luckily, I found Magnet, where I was paired with a software development student who was looking to build websites to get more front-end experience. I couldn't be happier with the end result!"</p>
